...
class Config:
    ...
    REGISTER_RATE_LIMIT_ATTEMPTS = _get_int_env("REGISTER_RATE_LIMIT_ATTEMPTS", 10)
    REGISTER_RATE_LIMIT_WINDOW_SECONDS = _get_int_env("REGISTER_RATE_LIMIT_WINDOW_SECONDS", 3600)
    RATELIMIT_STORAGE_URI = os.environ.get("RATE_LIMIT_STORAGE_URI", "redis://localhost:6379/0")
    RATELIMIT_STORAGE_FALLBACK_URI = os.environ.get("RATE_LIMIT_STORAGE_FALLBACK_URI", "memory://")
    RATELIMIT_BACKEND_HEALTHCHECK_ENABLED = _get_bool_env("RATELIMIT_BACKEND_HEALTHCHECK_ENABLED", True)
    RATELIMIT_FAIL_ON_BACKEND_ERROR = _get_bool_env("RATELIMIT_FAIL_ON_BACKEND_ERROR", True)
    RATELIMIT_SWALLOW_ERRORS = _get_bool_env("RATELIMIT_SWALLOW_ERRORS", False)
